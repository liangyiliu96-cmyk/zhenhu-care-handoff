...
import type { PreRoundBriefResponse } from '@/types/patient-dashboard';

interface ClinicalIntakePanelProps {
  patientId: string;
  stateVersion: number;
  historyGaps?: PreRoundBriefResponse['history_gaps'];
}

export default function ClinicalIntakePanel({ patientId, stateVersion, historyGaps = [] }: ClinicalIntakePanelProps) {
