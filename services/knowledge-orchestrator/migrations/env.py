"""Alembic 迁移环境 —— knowledge-orchestrator 服务。

- target_metadata 使用 zhenhu.knowledge.models.Base.metadata，
...
from zhenhu.knowledge import models  # noqa: E402
from zhenhu.knowledge.models import Base  # noqa: E402
